...
${CODEGEN_PKG}/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/codefresh-io/argo-rollouts/pkg/client github.com/codefresh-io/argo-rollouts/pkg/apis \
  "rollouts:v1alpha1" \
  --output-base "${TEMP_DIR}" \
  --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.go.txt

cp -r "${TEMP_DIR}/github.com/codefresh-io/argo-rollouts/." "${SCRIPT_ROOT}/"
