...
replace k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.31.12

replace k8s.io/endpointslice => k8s.io/endpointslice v0.31.12

replace k8s.io/kms => k8s.io/kms v0.31.12
...
replace k8s.io/cri-client => k8s.io/cri-client v0.31.12
