...
func (c *FakeExperiments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Experiment, err error) {
	emptyResult := &v1alpha1.Experiment{}
	obj, err := c.Fake.
...
func (c *FakeExperiments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ExperimentList, err error) {
	emptyResult := &v1alpha1.ExperimentList{}
	obj, err := c.Fake.
...
func (c *FakeExperiments) UpdateStatus(ctx context.Context, experiment *v1alpha1.Experiment, opts v1.UpdateOptions) (result *v1alpha1.Experiment, err error) {
	emptyResult := &v1alpha1.Experiment{}
	obj, err := c.Fake.
