...
func (c *FakeAnalysisRuns) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AnalysisRun, err error) {
	emptyResult := &v1alpha1.AnalysisRun{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(analysisrunsResource, c.ns, name, options), emptyResult)
...
func (c *FakeAnalysisRuns) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AnalysisRunList, err error) {
	emptyResult := &v1alpha1.AnalysisRunList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(analysisrunsResource, analysisrunsKind, c.ns, opts), emptyResult)
...
func (c *FakeAnalysisRuns) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(analysisrunsResource, c.ns, opts))
...
func (c *FakeAnalysisRuns) Create(ctx context.Context, analysisRun *v1alpha1.AnalysisRun, opts v1.CreateOptions) (result *v1alpha1.AnalysisRun, err error) {
	emptyResult := &v1alpha1.AnalysisRun{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(analysisrunsResource, c.ns, analysisRun, opts), emptyResult)
...
func (c *FakeAnalysisRuns) Update(ctx context.Context, analysisRun *v1alpha1.AnalysisRun, opts v1.UpdateOptions) (result *v1alpha1.AnalysisRun, err error) {
	emptyResult := &v1alpha1.AnalysisRun{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(analysisrunsResource, c.ns, analysisRun, opts), emptyResult)
...
func (c *FakeAnalysisRuns) UpdateStatus(ctx context.Context, analysisRun *v1alpha1.AnalysisRun, opts v1.UpdateOptions) (result *v1alpha1.AnalysisRun, err error) {
	emptyResult := &v1alpha1.AnalysisRun{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(analysisrunsResource, "status", c.ns, analysisRun, opts), emptyResult)
...
func (c *FakeAnalysisRuns) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(analysisrunsResource, c.ns, opts, listOpts)
...
func (c *FakeAnalysisRuns) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AnalysisRun, err error) {
	emptyResult := &v1alpha1.AnalysisRun{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(analysisrunsResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
